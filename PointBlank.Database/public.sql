...
CREATE TABLE "public"."accounts" (
  ...
  "gp" int4 NOT NULL DEFAULT 999999,
  ...
  "money" int4 NOT NULL DEFAULT 999999,
  ...
  "kuyraicoin" int4 NOT NULL DEFAULT 0,
  ...
  "money_promotion" int4 NOT NULL DEFAULT 0,
...
-- ----------------------------
INSERT INTO "public"."info_cafe_items" VALUES (0, 103004, 'K-2', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 104006, 'K-1', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 105003, 'SSG-69', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 202003, 'K-5', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 301001, 'M-7', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 407001, 'K-400', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 508001, 'Smoke', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1500511, 'Raptor', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1500512, 'String', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1500513, 'Acid', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1000700000, 'Character Face', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1000800000, 'Character Head', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1000900000, 'Character Jacket', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1001000000, 'Character Poket', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1001100000, 'Character Glove', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1001200000, 'Character Belt', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1001300000, 'Character Holster', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (0, 1001400000, 'Character Skin', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (2, 601001, 'เรด บูลส์', 1, 3);
INSERT INTO "public"."info_cafe_items" VALUES (2, 602002, 'แอคซิด โพล', 1, 3);
...
-- ----------------------------
INSERT INTO "public"."info_channels" VALUES (1, 0, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 1, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 2, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 3, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 4, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 5, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 6, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 7, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 8, 1, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
INSERT INTO "public"."info_channels" VALUES (1, 9, 4, '{col: 0, 255, 0, 255}ยินดีต้อนรับสู่{/col} {col: 255, 25, 50, 255}Point Blank IVAN+{/col}', 0);
...
-- ----------------------------
INSERT INTO "public"."info_gameservers" VALUES (0, 1, 1, '103.91.204.192', 39190, 1908, 700);
INSERT INTO "public"."info_gameservers" VALUES (1, 1, 1, '103.91.204.192', 39191, 1909, 700);
...
-- ----------------------------
INSERT INTO "public"."info_login_configs" VALUES (1, 'f', 't', '', '3.24', 't', 'http://www.pbmvp.com', 5242624, 16724787, 'ยินดีต้อนรับเข้าสู่เซิร์ฟเวอร์ Point Blank IVAN+ !!', 'Point Blank IVAN+ Evolution!!', 'http://pbmvp.com/', 'https://www.facebook.com/SuppakornChawruahuk');
...
-- Records of onlines
-- ----------------------------
INSERT INTO "public"."onlines" VALUES (0, 0, 0);
...
-- ----------------------------
INSERT INTO "public"."server_messages" VALUES (1, 'EXP', '>>>>> อัตราการ x EXP ปกติ 10,000 EXP <<<<<', 53);
INSERT INTO "public"."server_messages" VALUES (2, 'Event', '- วัน เสาร์ & อาทิตย์ [ EXP & POINT x 30,000%]', 5);
INSERT INTO "public"."server_messages" VALUES (4, 'Web', '- เว็บไซต์:  HTTP://103.91.204.192', 7);
INSERT INTO "public"."server_messages" VALUES (3, 'FanPage', 'ติดตามกิจกรรมใหม่ๆได้ที่แฟนเพจ @PB-IVAN+', 6);
...
INSERT INTO "public"."shop" VALUES (10440504, 104405, 'OA-93 Midnight Blue III', 0, 0, 864000, 2, 1, 2, 0, 0, 2);
...
INSERT INTO "public"."shop" VALUES (10440704, 104407, 'P90 Midnight Blue III', 0, 0, 864000, 2, 1, 2, 0, 0, 2);
...
INSERT INTO "public"."shop" VALUES (10449804, 104498, 'OA-93 Hallowen 2017', 0, 0, 864000, 2, 1, 2, 0, 0, 2);
...
INSERT INTO "public"."shop" VALUES (10502999, 105029, 'VSK94', 55000, 0, 100, 1, 2, 2, 0, 0, 0);
INSERT INTO "public"."shop" VALUES (10503004, 105030, 'Cheytac M200', 55000, 0, 100, 1, 2, 2, 0, 18, 0);
...
INSERT INTO "public"."shop" VALUES (10503599, 105035, 'SVU', 45000, 0, 100, 1, 2, 2, 0, 0, 0);
...
INSERT INTO "public"."shop" VALUES (10521104, 105211, 'AS-50 Renegade', 0, 0, 864000, 2, 1, 2, 0, 0, 2);
...
INSERT INTO "public"."shop" VALUES (10521704, 105217, 'AS-50 Midnight Blue III', 0, 0, 864000, 2, 1, 2, 0, 0, 2);
...
INSERT INTO "public"."shop" VALUES (31501604, 315016, 'BoneKnife Beyond', 0, 0, 86400, 2, 1, 2, 0, 0, 2);
INSERT INTO "public"."shop" VALUES (31501608, 315016, 'BoneKnife Beyond', 0, 0, 604800, 2, 1, 2, 0, 0, 2);
INSERT INTO "public"."shop" VALUES (31501612, 315016, 'BoneKnife Beyond', 0, 0, 2592000, 2, 1, 2, 0, 0, 2);
...
INSERT INTO "public"."shop" VALUES (160018704, 1701187, 'Muzzle Color', 0, 750, 1, 1, 1, 2, 0, 0, 2);
...
INSERT INTO "public"."shop" VALUES (160019304, 1701193, 'Change Effect Clan', 0, 99999999, 1, 1, 1, 2, 0, 0, 2);
...
SELECT setval('"public"."auto_ban_seq"', 2, true);
SELECT setval('"public"."ban_seq"', 2, false);
SELECT setval('"public"."channels_id_seq"', 2, false);
SELECT setval('"public"."check_event_seq"', 2, true);
SELECT setval('"public"."clan_seq"', 2, true);
SELECT setval('"public"."clans_id_seq"', 2, true);
SELECT setval('"public"."contas_seq"', 2, true);
SELECT setval('"public"."gameservers_id_seq"', 2, false);
SELECT setval('"public"."gift_id_seq"', 2, true);
SELECT setval('"public"."ipsystem_id_seq"', 2, false);
SELECT setval('"public"."items_id_seq"', 2, true);
SELECT setval('"public"."jogador_amigo_seq"', 2, true);
SELECT setval('"public"."jogador_inventario_seq"', 2, true);
SELECT setval('"public"."jogador_mensagem_seq"', 2, true);
SELECT setval('"public"."loja_seq"', 2, true);
SELECT setval('"public"."message_id_seq"', 2, true);
SELECT setval('"public"."player_characters_id_seq"', 2, true);
SELECT setval('"public"."player_eqipment_id_seq"', 2, true);
SELECT setval('"public"."player_friends_player_account_id_seq"', 2, false);
SELECT setval('"public"."player_topups_seq"', 2, true);
SELECT setval('"public"."players_id_seq"', 2, true);
SELECT setval('"public"."storage_seq"', 2, true);
...
-- ----------------------------
-- Primary Key structure for table server_messages
-- ----------------------------
ALTER TABLE "public"."server_messages" ADD CONSTRAINT "server_messages_pkey" PRIMARY KEY ("id");
